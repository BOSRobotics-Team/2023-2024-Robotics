...
public class COTSFalconSwerveConstants {
  ...
  /** SDS MK3 - 8.16 : 1 */
  public static COTSFalconSwerveConstants SDSMK3_Standard() {
    return SDSMK3(8.16 / 1.0);
  }

  /** SDS MK3 - 6.86 : 1 */
  public static COTSFalconSwerveConstants SDSMK3_Fast() {
    return SDSMK3(6.86 / 1.0);
  }
  ...
  /** SDS MK4 - 8.14 : 1 */
  public static COTSFalconSwerveConstants SDSMK4_L1() {
    return SDSMK4(8.14 / 1.0);
  }

  /** SDS MK4 - 6.75 : 1 */
  public static COTSFalconSwerveConstants SDSMK4_L2() {
    return SDSMK4(6.75 / 1.0);
  }

  /** SDS MK4 - 6.12 : 1 */
  public static COTSFalconSwerveConstants SDSMK4_L3() {
    return SDSMK4(6.12 / 1.0);
  }

  /** SDS MK4 - 5.14 : 1 */
  public static COTSFalconSwerveConstants SDSMK4_L4() {
    return SDSMK4(5.14 / 1.0);
  }
  ...
  /** SDS MK4i - 8.14 : 1 */
  public static COTSFalconSwerveConstants SDSMK4i_L1() {
    return SDSMK4i(8.14 / 1.0);
  }

  /** SDS MK4i - 6.75 : 1 */
  public static COTSFalconSwerveConstants SDSMK4i_L2() {
    return SDSMK4i(6.75 / 1.0);
  }

  /** SDS MK4i - 6.12 : 1 */
  public static COTSFalconSwerveConstants SDSMK4i_L3() {
    return SDSMK4i(6.12 / 1.0);
  }
}
